...
The memory footprint is about 1.4 TB at MXFP4 (versus ~5.6 TB at FP16). Some sources cite 594 GB, but that does not match 2.8T at 4-bit and appears to be an error. Moonshot recommends **supernodes of 64+ accelerators** for serving.
...
- Positioning: cheaper than GPT-5.6 Sol ($5/$30), in the Claude Sonnet 5 tier.
